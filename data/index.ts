export const DATA = {
  ...
  about: {
    ...
    experience: [
      ...
      {
        title: "Senior Full Stack Engineer — Consensys/ Web3auth - Wallet SDK & MPC Infrastructure",
        date: "May 2022 - Dec 2024",
        icon: "mdi:wallet",
        description: [
          "Built Plug N Play and Core Kit SDKs — wallet creation in <0.8s with 2.3x higher user conversion rates",
          "Developed smart wallet SDKs and Global Pay multi-currency wallets across 6 platforms (TypeScript, Node, React, Rust, Android, Swift)",
          "Engineered TKey MPC key management — non-custodial, seed-phrase-free auth reducing login friction by 25%",
          "Integrated Safe MPC wallet with MetaMask Snap and Trust Wallet",
          "SOC2/CCPA/GDPR-compliant infrastructure supporting 10+ blockchain ecosystems",
          "Achieved 99.98% uptime via liveness monitoring frameworks",
          "Automated Sapphire DKG deployment — 40% speed improvement",
          "CI/CD pipelines with GitHub Actions and AWS Lambda — 50% faster releases",
        ],
      },
      {
